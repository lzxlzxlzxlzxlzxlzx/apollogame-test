...
try {
  ...
  writeFileSync(`${out}browser-roundtrip.json`, JSON.stringify({ scope: 'formal S4 route; real pointer and normal-clock shop-deploy-battle-result-next-shop; nine skills separately covered by production tests', errors, trace }, null, 2));
  await browser.close();
}
